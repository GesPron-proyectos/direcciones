<?php
class personal_m extends EMP_Model{
	public function EMP_Model() { $this->__construct(); }

	public function __construct(){
		parent::__construct();
		$this->_table = '2_cuentas_personal';
		$this->primary_key = 'id';
		$this->alias = 'b';
  ...
  public function eliminar_bienes($id){
	...
	public function get_cuentas_personal($where){


		
		$cols[] = 'tipog as tipo';
		$cols[] = 'nombreg as nombre';
		$cols[] = 'rutg as rut';
		$cols[] = 'domiciliog as Domicilio';
		
		$this->db->select($cols);
		
	    $this->db->from("2_cuentas_personal");
