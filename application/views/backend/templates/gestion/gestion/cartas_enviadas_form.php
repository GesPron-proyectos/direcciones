...
<table id="tbinstituciones" class="tabla_list cell-border" data-page-length='25'>
    ...
    <tbody id="rows">
      <?php
      $i = 0;
      foreach ($cartas_enviadas2 as $key=>$cartas):?>
        <tr id="tr_<?php echo $cartas->instituciones_idinstituciones; ?>" class="tr_cartas">
          ...
          <td class="num_list"><?php $carta_institucion = $cartas->instituciones_idinstituciones;?>
            <input type="hidden" class="idinstituto" name="instituciones_idinstituciones" value="<?php echo $carta_institucion[0];?>" style="border:none;background: #fff;" readonly="readonly">#<?php echo $carta_institucion; ?>
          </td>
          ...
          <td>
            <select name="estado" id="<?php echo $cartas->idcartas_enviadas; ?>" data-tipo="cartas_enviadas">
              <option value="0" selected="selected">Sin Respuesta</option>
            </select>
