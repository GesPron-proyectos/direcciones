...
<td align="center"><?php echo $val->tribunal?><br><?php echo $val->jurisdiccion;?><br><?php echo $val->letraC;?><?php echo '-';?><?php echo $val->rol;?><?php echo '-';?><?php echo $val->anio;?></td>

<!--<td><?php echo $val->nom_deudor;?></td>-->
<td><?php echo $val->ap_pat;?></td>
<!--<td><?php echo $val->ap_mat;?></td>-->
<td><?php echo $val->etapa_pjud;?></td>
<td><?php echo $val->tramite_pjud;?></td>
<td><?php echo $val->descripcion_pjud;?></td>

<!--<td><?php echo $val->fecha_etapa_pjud;?></td>-->
  ...
  <td style="text-align:center;">
  <?php 
	$link = "http://200.73.113.95:81/estadodiario/index.php/admin/receptor_r/listar/{$val->id_mov}";
	if($val->id_mov){ ?>
