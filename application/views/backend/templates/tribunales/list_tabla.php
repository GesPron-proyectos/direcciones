...
<tr class="menu" style="line-height:20px; height:50px;">
  ...
  <td width="13%" class="nombre">Tribunales</td>
   <td width="13%" class="nombre">Jurisdicción</td>
  <td width="13%" class="nombre" style="display:none">Corte</td>
  <td width="13%" class="nombre">Posición</td>
...
<tr id="tools_k<?php echo $val->id?>" class="tr <?php if ($i%2==0){echo 'b';}else{echo 'a';}?>">
     <td><?php echo $val->tribunal_hijo;?></td>
  <td width="13%" class="nombre"> <?php if($val->padre == '0'){ ?>
    <?php  echo $val->tribunal ?> </td>
   <?php } ?> 
    
    <td style="display:none"><?php echo $val->jurisdiccion;?></td>
