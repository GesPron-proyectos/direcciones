...
$id=''; $perfil='0'; $username=''; $password=''; $nombres=''; $apellidos=''; $correo=''; $cargo=''; $rut_procurador=''; $check= '';
...
<div class="blq">
    ...
    <div class="clear"></div>
        ...
        <div class="cont-form">
        <?php $n_check = FALSE; if ($check == 'S'){$n_check = TRUE;}?>
		<?php  echo form_checkbox(array('name'=>'check','class'=>'check','style'=>'width:25px'),'S',$n_check);?> Activar estado
        <div class="clear"></div>
	   	<span class="error" id="error_rut"></span>
       	</div>
   <div class="clear"></div>
...
<div class="blq">
    ...
    <div class="dos">
      ...
      <div class="cont-form">
        ...
        <input id="password" name="password" type="password" value="<?php echo $password;?>" style="width:150px;">
       <div class="clear"></div>
