...
class Gestion extends CI_Controller {
	...
	function __construct() {
		...
		$this->load->model ( 'tipo_causa_m' );
		$this->load->model ( 'anio_rol_m' );
		...
		if($perf ==3)
			{
				...
				if($obj->id==1 || $obj->id==2 || $obj->id==3 || $obj->id==5 || $obj->id==6 || $obj->id==7 || $obj->id==8 || $obj->id==9 || $obj->id==10)
	...
	//	$this->form_validation->set_rules('id', 'tipo', 'trim|xss_clean');
		...
		if ($this->form_validation->run() == TRUE){
			...
			$fields_save['id_juzgado'] = $this->input->post('id_tribunalnew');
			$fields_save['numero_rol'] = $this->input->post('rolE');
			$fields_save['tipo_causa'] = $this->input->post('id');
		//	$fields_save['tipo_causa_ex'] = $this->input->post('letra_rol_e');
			$fields_save['anio'] = $this->input->post('anio');
			...
			if ($this->input->post('id_tribunalnew')>0) { $fields_save_cuenta['id_tribunal'] = $this->input->post('id_tribunalnew');}
			...
			if ($this->input->post('id')>0) { $fields_save_cuenta['letraC'] = $this->input->post('id');}
			if ($this->input->post('letra_rol_e')>0) { $fields_save_cuenta['letraE'] = $this->input->post('letra_rol_e');}
			if ($this->input->post('anio')>0) { $fields_save_cuenta['anio'] = $this->input->post('anio');}
			if ($this->input->post('anio_ex')>0) { $fields_save_cuenta['anioE'] = $this->input->post('anio_ex');}
			if ($this->input->post('id_marca')>0) { $fields_save_cuenta['id_marcas_especiales'] = $this->input->post('id_marca');}
			if ($this->input->post('id_distritoExh')>0) { $fields_save_cuenta['id_distrito_ex'] = $this->input->post('id_distritoExh');}
			//print_r($fields_save);
	...
	function guardar_cuenta($id_cuenta){
		...
		$this->form_validation->set_rules('letraE','tipo','trim|xss_clean');
		$this->form_validation->set_rules('id_marcas_especiales','marcas','trim|xss_clean');
		$this->form_validation->set_rules('anioE','anio','trim|xss_clean');
		$this->form_validation->set_rules('id_distrito_ex','distritoex','trim|xss_clean');
		$this->form_validation->set_rules('id_tribunal_ex','tribunalex','trim|xss_clean');
		...
		if ($this->session->userdata("usuario_perfil")==1 || $this->session->userdata("usuario_perfil")==2){
			...
			//########################## NUEVOS CAMPOS #################################### //
			$this->form_validation->set_rules('dias_mora_asig','dias mora asignacion','trim|xss_clean');
			$this->form_validation->set_rules('licitacion','Licitacion','trim|xss_clean');
			$this->form_validation->set_rules('fecha_primer_vcto','Fecha Primer Vcto','trim|xss_clean');
			//$this->form_validation->set_rules('tipo_deudor','Tipo Deudor','trim|xss_clean');
			$this->form_validation->set_rules('dias_mora','Dias Mora','trim|xss_clean');
			$this->form_validation->set_rules('tramo_mora','Tramo Mora','trim|xss_clean');
		...
		if ($this->form_validation->run() == TRUE){
			...
			//Nuevo Carlos Rojas 7/6/16
			$fields_save['id_distrito_ex'] = $this->input->post('id_distritoExh');
			$fields_save['id_tribunal_ex'] = $this->input->post('id_tribunal_ex_intermedio');
			$fields_save['id_tribunal_ex'] = $this->input->post('id_tribunal_exw');
			$fields_save['rolE'] = $this->input->post('rolE');
			$fields_save['letraE'] = $this->input->post('letra_rol_e');
			$fields_save['id_marcas_especiales'] = $this->input->post('id_marca');
			$fields_save['anioE'] = $this->input->post('anio_ex');
			$fields_save['id_tribunal_ex'] = $this->input->post('id_tribunal_ex_intermedio');
			$fields_save['id_distrito_ex'] = $this->input->post('id_distritoExh');
...
//########################## NUEVOS CAMPOS #################################### //
			$fields_save['dias_mora_asig'] = $this->input->post('dias_mora_asig');
			$fields_save['licitacion'] = $this->input->post('licitacion');
			$fields_save['fecha_primer_vcto'] = $this->input->post('fecha_primer_vcto');
			$fields_save['tipo_deudor'] = $this->input->post('tipo_deudor');
			$fields_save['dias_mora'] = $this->input->post('dias_mora');
			$fields_save['tramo_mora'] = $this->input->post('tramo_mora');
//######################## FIN NUEVOS CAMPOS ################################### //
			...
			{ 
				...
				$fields_save['exorto'] = $this->input->post('exorto');
				...
				//########################## NUEVOS CAMPOS #################################### //
				if ($this->input->post('dias_mora_asig')!='') { $fields_save['dias_mora_asig'] = $this->input->post('dias_mora_asig');}

				if ($this->input->post('licitacion')!='') { $fields_save['licitacion'] = $this->input->post('licitacion');}

				if ($this->input->post('fecha_primer_vcto')!='') { $fields_save['fecha_primer_vcto'] = $this->input->post('fecha_primer_vcto');}

			//	if ($this->input->post('tipo_deudor')!='') { $fields_save['tipo_deudor'] = $this->input->post('tipo_deudor');}

			//	if ($this->input->post('dias_mora')!='') { $fields_save['dias_mora'] = $this->input->post('dia_mora');}

				if ($this->input->post('tramo_mora')!='') { $fields_save['tramo_mora'] = $this->input->post('tramo_mora');}
				//########################## FIN NUEVOS CAMPOS #################################### //
	...
	function guardar_pagare($id_cuenta,$id=''){
        ...
        $this->form_validation->set_rules('dias_mora', 'Días Mora', 'trim|xss_clean');
	...
	function guardar_etapa($id_cuenta,$id=''){
		...
		//print_r($cta);
			...
			$fields_save['fecha_etapa'] = date('Y-m-d H:i:s',strtotime($this->input->post('fecha_etapa')));
			$fields_save['observaciones'] = $this->input->post('observaciones');
			//print_r($fields_save);
	...
	function index($id_cuenta='',$tab='1',$idregistro=''){
       ...
       // $this->load->view('backend/templates/gestion/gestion/datos_cuenta', $data);


		
		///////// JURISDICCION /////////////////
		$distritos = $this->db->get("jurisdiccion")->result();
		
      	
		///////// JURISDICCION /////////////////
		$jurisdiccion= array();
		$a=$this->distrito_m->order_by("jurisdiccion","ASC")->get_many_by( array());
		$jurisdiccion[0]='Seleccionar';
		foreach ($a as $obj) {$jurisdiccion[$obj->id] = $obj->jurisdiccion;}
		
		//print_r($data);
	
		///////// TRIBUNALES /////////////////
		$tribunales = array();
		$a=$this->tribunales_m->order_by("id","ASC")->get_many_by( array());
		$tribunales[0]='Seleccionar';
		foreach ($a as $obj) {$tribunales[$obj->id] = $obj->tribunal;}	

		////////////TIPO CAUSA ///////////////////
		$tipo_causa = array();
		$a=$this->tipo_causa_m->order_by("tipo","ASC")->get_many_by(array());
		$tipo_causa[0]='Seleccionar';
		foreach ($a as $obj) {$tipo_causa[$obj->id] = $obj->tipo;}

		/////////// MARCAS ESPECIALES ////////////////
		$marcas_especiales = array();
		$a=$this->marcas_especiales_m->order_by("marca","ASC")->get_many_by(array());
		$marcas_especiales[0]='Seleccionar';
		foreach ($a as $obj) {$marcas_especiales[$obj->idMarca] = $obj->marca;}



		////////////AÑO ROL ///////////////////
		$anio_rol = array();
		$a=$this->anio_rol_m->order_by("anio","ASC")->get_many_by(array());
		$anio_rol[0]='Seleccionar';
		foreach ($a as $obj) {$anio_rol[$obj->id] = $obj->anio;}
		
		/*
		$tribunalesE = array();
		//$a = $this->tribunales_m->order_by("id","ASC")->get_many_by( array( "padre" => $cuenta->id_distrito_ex) );
		$a = $this->tribunales_m->order_by("id","ASC")->get_many_by(array('activo'=>'S','padre'=>$cuenta->id_distrito_ex));
	   ...
	   * GASTOS
	    ...
	    * DOCUMENTOS
		...
		$this->data['jurisdiccion'] = $jurisdiccion;
		...
		$this->data['tipo_causa'] = $tipo_causa;
		$this->data['marcas_especiales'] = $marcas_especiales;
		$this->data['anio_rol'] = $anio_rol;
