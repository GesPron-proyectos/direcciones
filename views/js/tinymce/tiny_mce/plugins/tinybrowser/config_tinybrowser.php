...
$tinybrowser['path']['image'] = '/home/camaleon/public_html/web/public/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/home/camaleon/public_html/web/public/images/'; // Media files location
$tinybrowser['path']['file']  = '/home/camaleon/public_html/web/public/images/'; // Other files location
