<table class="stable" width="100%">
    <tr><td colspan="4"><h3>Ingresar un nuevo documento:</h3><br></td></tr>
    <tr>
        <td>Archivo:</td>
        <td>
        <input type="hidden" name="otro_upload" value="<?php echo $cuenta->id_etapa;?>" />
        <input type="file" id="file5" name="file5" style="float:left;"/>
        <?php echo form_error('observaciones','<br><span class="error">','</span>');?>
        </td>
    </tr>
    <tr>
    <tr><td colspan="2"><hr style="border:1px solid #CDCCCC"><br><h3>Documentos:</h3><br></td></tr>
    <tr>
        <td colspan="2">
        <div id="documentos_all_table">
        <?php $this->load->view('backend/templates/procurador/gestion/documento_tabla'); ?>
        </div>
    </td></tr>
</table>
