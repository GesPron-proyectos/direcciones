...
<?php echo form_open_multipart(site_url().'/admin/cuentas/cargar_excel/guardar_archivo/'.$url_form);?>
...
<div class="blq">
	<div class="dos">
	<?php echo form_open(site_url().'/admin/cuentas/cargar_excel/importar_archivo/'.$url_form);?>
		<div class="campos fila" >
		<?php if ($archivo!=''):?>
	 	<div class="cont-form">
	      ...
	      <div class="clear"></div>
	      <?= form_error('id_mandante','<span class="error">', '</span>');?> 
		</div>
		<div class="cont-form">
