...
<?php echo form_open_multipart(site_url().'/admin/importar/cargar_excel_falabella/guardar_archivo_falabella/'.$url_form);?>
...
<div class="titulo">
    ...
    <strong style="float:left; margin-right:10px;">Archivo para carga masiva Falabella</strong> 
...
<?php echo form_close();?>
<div class="titulo">
<strong style="float:left; margin-right:10px;">Importador masivo Falabella</strong> 
</div>
<?php $url_form = ''; if (!empty($id)){$url_form = $id;}?>

<div class="blq">
	<div class="dos">
	<?php echo form_open(site_url().'/admin/cuentas/importar_fallabella_fullpay/'.$url_form);?>
		<div class="campos fila" >
		<?php if ($archivo!=''):?>
